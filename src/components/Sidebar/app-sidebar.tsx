...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar
      collapsible="icon"
      {...props}
      className="p-1 bg-bgprimary"
      variant="floating"
    >
      <SidebarHeader className="bg-sidebarcolor rounded-t-xl">
        <TeamSwitcher teams={mockData.teams} />
      </SidebarHeader>
      <SidebarContent className="bg-sidebarcolor">
      ...
      <SidebarFooter className="bg-sidebarcolor rounded-b-xl">
